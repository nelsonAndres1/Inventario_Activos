        ...
        if (response.status != 'error') {
          ...
          this._gener02Service.signup(this.gener02, this.v).subscribe(
            response => {
              ...
              if (response.sub == '124'|| response.sub == '619'||response.sub == '1163'||response.sub == '1113'||response.sub == '101'||response.sub == '1750'||response.sub == '603' || response.sub == '1132' || response.sub == '1315' || response.sub == '1982') {
